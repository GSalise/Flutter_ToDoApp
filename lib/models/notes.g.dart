...
const NotesSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'status': PropertySchema(
      ...
      name: r'status',
      type: IsarType.byte,
      enumMap: _NotesstatusEnumValueMap,
    ),
...
Notes _notesDeserialize(
  ...
  object.id = id;
  object.status = _NotesstatusValueEnumMap[reader.readByteOrNull(offsets[2])] ??
      Status.pending;
...
P _notesDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (_NotesstatusValueEnumMap[reader.readByteOrNull(offset)] ??
          Status.pending) as P;
    case 3:
      return (reader.readStringOrNull(offset)) as P;
    case 4:
...
const _NotesstatusEnumValueMap = {
  'pending': 0,
  'completed': 1,
};
const _NotesstatusValueEnumMap = {
  0: Status.pending,
  1: Status.completed,
};
...
extension NotesQueryWhereSort on QueryBuilder<Notes, Notes, QWhere> {
  ...
  QueryBuilder<Notes, Notes, QAfterWhere> anyTitle() {
    return QueryBuilder.apply(this, (query) {
...
extension NotesQueryWhere on QueryBuilder<Notes, Notes, QWhereClause> {
  ...
  QueryBuilder<Notes, Notes, QAfterWhereClause> titleIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Notes, Notes, QAfterWhereClause> titleIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Notes, Notes, QAfterWhereClause> titleEqualTo(String? title) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'title',
        value: [title],
  ...
  QueryBuilder<Notes, Notes, QAfterWhereClause> titleNotEqualTo(String? title) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Notes, Notes, QAfterWhereClause> titleGreaterThan(
    String? title, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Notes, Notes, QAfterWhereClause> titleLessThan(
    String? title, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Notes, Notes, QAfterWhereClause> titleBetween(
    String? lowerTitle,
    String? upperTitle, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Notes, Notes, QAfterWhereClause> titleStartsWith(
      String TitlePrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'title',
  ...
  QueryBuilder<Notes, Notes, QAfterWhereClause> titleIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'title',
        value: [''],
  ...
  QueryBuilder<Notes, Notes, QAfterWhereClause> titleIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension NotesQueryFilter on QueryBuilder<Notes, Notes, QFilterCondition> {
  ...
  QueryBuilder<Notes, Notes, QAfterFilterCondition> statusEqualTo(
      Status value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'status',
  ...
  QueryBuilder<Notes, Notes, QAfterFilterCondition> statusGreaterThan(
    Status value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Notes, Notes, QAfterFilterCondition> statusLessThan(
    Status value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Notes, Notes, QAfterFilterCondition> statusBetween(
    Status lower,
    Status upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension NotesQuerySortBy on QueryBuilder<Notes, Notes, QSortBy> {
  ...
  QueryBuilder<Notes, Notes, QAfterSortBy> sortByStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.asc);
    });
  }

  QueryBuilder<Notes, Notes, QAfterSortBy> sortByStatusDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NotesQuerySortThenBy on QueryBuilder<Notes, Notes, QSortThenBy> {
  ...
  QueryBuilder<Notes, Notes, QAfterSortBy> thenByStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.asc);
    });
  }

  QueryBuilder<Notes, Notes, QAfterSortBy> thenByStatusDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.desc);
    });
  }
...
extension NotesQueryWhereDistinct on QueryBuilder<Notes, Notes, QDistinct> {
  ...
  QueryBuilder<Notes, Notes, QDistinct> distinctByStatus() {
    return QueryBuilder.apply(this, (query) {
...
extension NotesQueryProperty on QueryBuilder<Notes, Notes, QQueryProperty> {
  ...
  QueryBuilder<Notes, Status, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
